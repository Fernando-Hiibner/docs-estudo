...
#Axis -> Meio que a quantidade de linhas, é tipo a tupla, ou lista dentro da lista maior -> plural = axes
#Largura(Length) -> Quantidade de elementos dentro de um axis

#Funções mais importantes do array numpy (ndarray)
